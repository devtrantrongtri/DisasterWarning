...
public class DisasterWarningTest {
    ...
    void testGetterAndSetter() {
        ...
        DisasterWarning warning = new DisasterWarning(0, disaster, location, Date.valueOf("2024-09-28"), "Flood expected", "active");
    ...
    void testConstructor() {
        ...
        DisasterWarning warning = new DisasterWarning(disaster, location, Date.valueOf("2024-09-28"), "Severe earthquake warning", "inactive");

        assertNotNull(warning);
        assertEquals("Severe earthquake warning", warning.getDescription());
        assertEquals("inactive", warning.getStatus());
    }
