...
public class DisasterWarningTest {
    ...
    void testGetterAndSetter() {
        ...
        DisasterWarning warning = new DisasterWarning(0, disaster, location, Date.valueOf("2024-09-28"), Date.valueOf("2024-10-01"), "Flood expected");
        ...
        assertEquals(Date.valueOf("2024-10-01"), warning.getEndDate());
    ...
    void testConstructor() {
        ...
        DisasterWarning warning = new DisasterWarning(0, disaster, location, Date.valueOf("2024-09-28"), Date.valueOf("2024-10-01"), "Severe earthquake warning");
